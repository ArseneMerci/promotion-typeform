      ...
      <ToastContainer />
        ...
        <div className={`${styles.container} border-[1px] border-amber-500 rounded`}>
            ...
            <div className='flex '>
                ...
                {count === 1 || type === 'concept' ? <div onClick={handleSubmitFeedback} className={!loader ? 'flex justify-center cursor-pointer items-center bg-black text-white my-7 rounded w-[150px] h-[40px]' : 'flex justify-center items-center text-white my-7 rounded w-[150px] h-[40px] bg-gray-700 cursor-not-allowed'}> 
                    {!loader ? <h1 className='text-white font-semibold'>Submit</h1>
                    :
                    <div role="status" className='flex'>
                        <h1 className='text-white font-semibold mr-3 '>Processing...</h1>
            ...
            {type === 'management' && count === 0 ? <button className='bg-black text-white my-7 rounded w-[150px] h-[40px]' onClick={()=>dispatch(next())}>Next</button> : ''}
        </div>
    </div>
  )
}
